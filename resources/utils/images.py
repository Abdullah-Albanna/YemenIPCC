...
from utils.byte_objects import *
...
class Images:
    ...
    login_signup_hover_button_png = base64_string_to_image(
        login_signup_hover_button_png_base64
    )
    ...
    signup_entry_1_bg_icon_png = base64_string_to_image(
        signup_entry_1_bg_icon_png_base64
    )
    signup_entry_1_png = base64_string_to_image(signup_entry_1_png_base64)
    signup_entry_2_bg_icon_png = base64_string_to_image(
        signup_entry_2_bg_icon_png_base64
    )
    signup_entry_2_png = base64_string_to_image(signup_entry_2_png_base64)
    signup_entry_3_bg_icon_png = base64_string_to_image(
        signup_entry_3_bg_icon_png_base64
    )
    ...
    signup_login_hover_button_png = base64_string_to_image(
        signup_login_hover_button_png_base64
    )
