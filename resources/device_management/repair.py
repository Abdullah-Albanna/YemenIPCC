...
def repairiPhone(log_text) -> None:
    ...
    #     stdout = unpair_process.stdout
    #     stderr = unpair_process.stderr
    #     result = stdout + stderr

    result = iDevice.unpair()

    if result:
        color = "green"
        log_result = "Successfully unpair device"
    else:
        color = "red"
        log_result = "Failed to unpair device"
    ...
    # if arabic and ar_result is not None:
...
def pairAndCheck(log_text) -> None:
    ...
    if result:
        log_result = "Successfully paired with device"
        color = "green"
    else:
        log_result = "Failed to pair with device"
        color = "red"
